...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.photoID.setGeometry(QtCore.QRect(220, 200, 500, 500))
        ...
        self.name_nv.setGeometry(QtCore.QRect(220, 710, 800, 50))
        self.name_nv.setWordWrap(True)
        font = QtGui.QFont('Arial', 22)
        font.setBold(True)
        self.name_nv.setFont(font)

        self.position.setGeometry(QtCore.QRect(220, 750, 500, 50))
        font = QtGui.QFont('Arial', 20)
        # font.setItalic(True)
        self.position.setFont(font)

        self.mnv.setGeometry(QtCore.QRect(220, 790, 500, 50))
        font = QtGui.QFont('Arial', 20)
        # font.setItalic(True)
        self.mnv.setFont(font)

        self.time_log.setGeometry(QtCore.QRect(220, 830, 260, 50))
        font = QtGui.QFont('Arial', 20)
        self.time_log.setFont(font)

        self.temp.setGeometry(QtCore.QRect(220, 870, 355, 50))
        font = QtGui.QFont('Arial', 20)
